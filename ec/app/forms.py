...
class MyPaaswordResetForm(PasswordChangeForm):
...
class CustemProfileForm(forms.ModelForm):
    
    class Meta:
        
        model = custem
        fields = ['name','locality','mobile','city','zipcode','state']
        widgets = {
